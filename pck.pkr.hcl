...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo /opt/aws/amazon-cloudwatch-agent/bin/amazon-cloudwatch-agent-ctl -a fetch-config -m ec2 -c file:/Users/anujakale/Desktop/assignment05/webapp/cloudwatch-agent-config.json -s",
